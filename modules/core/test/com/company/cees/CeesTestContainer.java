...
public class CeesTestContainer extends TestContainer {

    public CeesTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cees/app.properties",
    ...
    public static class Common extends CeesTestContainer {

        public static final CeesTestContainer.Common INSTANCE = new CeesTestContainer.Common();
